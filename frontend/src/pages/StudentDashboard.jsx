    ...
    <div className="absolute inset-0 overflow-y-auto overflow-x-hidden" data-testid="student-dashboard">
      ...
      <div className="relative z-10 min-h-full flex flex-col items-center pb-8 md:pb-12">
        ...
        <section
          ...
          className="relative z-10 w-full max-w-4xl mx-auto pl-4 pr-6 sm:pr-8 md:pr-10 lg:pr-12 pt-4 pb-2 md:pt-6 md:pb-4 mb-4 md:mb-6 animate-[fadeSlideUp_0.8s_ease-out_both]"
        >
          <div
        ...
        {dv.upcoming_family ? (
          <>
            {homeLoading && (
              <section
                className="w-full max-w-4xl mx-auto pl-4 pr-6 sm:pr-8 md:pr-10 lg:pr-12 mb-4 md:mb-6"
                aria-busy="true"
            ...
            {!homeLoading && homeFetchError && (
              <section className="w-full max-w-4xl mx-auto pl-4 pr-6 sm:pr-8 md:pr-10 lg:pr-12 mb-4 md:mb-6" data-testid="dashboard-upcoming-error">
        ...
        <div className="w-full max-w-3xl mx-auto pl-4 pr-6 sm:pr-8 md:pl-6 md:pr-10 lg:pr-12 flex flex-col items-center">
