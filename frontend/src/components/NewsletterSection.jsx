      ...
      <div className={CONTAINER}>
        <div className="max-w-2xl mx-auto text-center">
          ...
          {sectionConfig?.subtitle && (
            <p className="text-sm text-gray-900 mb-4" style={sectionConfig?.subtitle_style ? { ...(sectionConfig.subtitle_style.font_color && { color: sectionConfig.subtitle_style.font_color }), ...(sectionConfig.subtitle_style.font_size && { fontSize: sectionConfig.subtitle_style.font_size }), ...(sectionConfig.subtitle_style.font_weight && { fontWeight: sectionConfig.subtitle_style.font_weight }) } : {}}>{sectionConfig.subtitle}</p>
          )}
