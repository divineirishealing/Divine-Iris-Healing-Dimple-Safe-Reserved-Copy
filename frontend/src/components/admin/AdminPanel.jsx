                      ...
                      <div className="p-5">
                        <div className="grid md:grid-cols-2 gap-4">
                          ...
                          <div className="flex items-center gap-2">
                            <input type="checkbox" id={`annual-prog-${editingId}`} checked={!!programForm.is_annual_program} onChange={e => setProgramForm(f => ({...f, is_annual_program: e.target.checked}))} className="rounded" />
                            <label htmlFor={`annual-prog-${editingId}`} className="text-[10px] font-semibold text-purple-700 cursor-pointer">Annual Program — enrolling auto-adds client to Annual Subscribers</label>
                          </div>
                          </>}
                        </div>
