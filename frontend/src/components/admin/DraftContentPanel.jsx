...
// Titles / subtitles are intentionally empty — the page renders no big
// centred section headings. The document's own headings live inside the
// body as **bold** markdown so the page flows exactly like the document.
// Sections 4-7 are custom type and appear after the 4 template sections.
// ---------------------------------------------------------------------------
...
The group healing format is intentional and powerful. When individuals heal together, the collective field creates an amplification effect — each participant's healing accelerates the healing of others. Families often join together, and the shared experience becomes its own medicine.`,
  ...
  },
  {
    ...
    title: '',
    subtitle: '',
    body: `**Why SoulSync Neuro∞Harmonics Is Unlike Anything Else**
...
✦ **Soul-level precision** — Akashic and Past Life work provides context no medical scan can offer`,
  ...
  },
  {
    ...
    title: '',
    subtitle: '',
    body: `**How SoulSync Neuro∞Harmonics Is Transforming Lives**
...
**Format**
Online — accessible globally, including Dubai and India
