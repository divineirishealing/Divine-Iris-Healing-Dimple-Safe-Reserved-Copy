...
function GuestMemberTable({
  ...
  return (
    <div
      className="w-full max-w-full rounded-lg border border-slate-200/90 bg-white shadow-sm"
      data-testid={wrapTestId}
    >
      <table className="w-full table-fixed text-left border-collapse" data-testid={tableTestId}>
        <thead>
          <tr className="bg-slate-100/95 border-b border-slate-200">
            <th className="px-1.5 sm:px-2 py-2 text-[8px] sm:text-[9px] font-bold uppercase tracking-wide text-slate-600 w-[19%] min-w-0">
              Name
            </th>
            <th className="px-1.5 sm:px-2 py-2 text-[8px] sm:text-[9px] font-bold uppercase tracking-wide text-slate-600 w-[13%] min-w-0">
              Relation
            </th>
            <th className="px-1.5 sm:px-2 py-2 text-[8px] sm:text-[9px] font-bold uppercase tracking-wide text-slate-600 w-[13%] min-w-0">
              Date of birth
            </th>
            <th className="px-1.5 sm:px-2 py-2 text-[8px] sm:text-[9px] font-bold uppercase tracking-wide text-slate-600 w-[7%] min-w-0">
              Age
            </th>
            <th className="px-1.5 sm:px-2 py-2 text-[8px] sm:text-[9px] font-bold uppercase tracking-wide text-slate-600 w-[11%] min-w-0">
              City
            </th>
            <th className="px-1.5 sm:px-2 py-2 text-[8px] sm:text-[9px] font-bold uppercase tracking-wide text-slate-600 w-[11%] min-w-0">
              Country
            </th>
            <th className="px-1.5 sm:px-2 py-2 text-[8px] sm:text-[9px] font-bold uppercase tracking-wide text-slate-600 w-[15%] min-w-0">
              Email
            </th>
            <th className="px-1.5 sm:px-2 py-2 text-[8px] sm:text-[9px] font-bold uppercase tracking-wide text-slate-600 w-[9%] min-w-0">
              Phone
            </th>
            <th className="px-0.5 py-2 w-8 min-w-[2rem] text-center" aria-label="Actions" />
          </tr>
        </thead>
        <tbody>
          {members.map((m, idx) => {
            ...
            >
              <td className="px-1.5 sm:px-2 py-1.5 align-middle min-w-0">
                <input
                  value={m.name}
                  onChange={(e) => updateRow(idx, 'name', e.target.value)}
                  disabled={rowReadOnly}
                  className="w-full min-w-0 max-w-full text-[10px] sm:text-[11px] border border-slate-200 rounded px-1 sm:px-1.5 py-1 bg-white disabled:opacity-60 disabled:bg-slate-50"
              ...
              <td className="px-1.5 sm:px-2 py-1.5 align-middle min-w-0">
                <select
                  ...
                  disabled={rowReadOnly}
                  className="w-full min-w-0 max-w-full text-[10px] sm:text-[11px] border border-slate-200 rounded px-0.5 sm:px-1 py-1 bg-white disabled:opacity-60 disabled:bg-slate-50"
                >
                  {relationships.map((r) => (
              ...
              <td className="px-1.5 sm:px-2 py-1.5 align-middle min-w-0">
                <input
                  ...
                  className="w-full min-w-0 max-w-full text-[10px] sm:text-[11px] border border-slate-200 rounded px-0.5 py-1 bg-white disabled:opacity-60 disabled:bg-slate-50"
                />
              </td>
              <td className="px-1.5 sm:px-2 py-1.5 align-middle min-w-0">
                <input
                  ...
                  disabled={rowReadOnly}
                  className="w-full min-w-0 max-w-full text-[10px] sm:text-[11px] border border-slate-200 rounded px-0.5 py-1 bg-white tabular-nums disabled:opacity-60 disabled:bg-slate-50"
                  placeholder="—"
                />
              </td>
              <td className="px-1.5 sm:px-2 py-1.5 align-middle min-w-0">
              ...
              <td className="px-0.5 py-1.5 align-middle text-center w-8 min-w-[2rem]">
    ...
    >
      <div className="flex flex-col gap-4 md:gap-5">
        ...
        <div className="mb-6 pb-5 border-b border-slate-100">
          <p className="text-[10px] font-semibold tracking-wide text-slate-500 uppercase">Household</p>
          <h3 className="text-base font-semibold text-slate-900 mt-1 leading-tight">
            Family <span className="text-slate-600 font-medium">&amp; guests</span>
          </h3>
          <p className="text-[11px] text-slate-500 mt-1.5 leading-snug max-w-3xl">
