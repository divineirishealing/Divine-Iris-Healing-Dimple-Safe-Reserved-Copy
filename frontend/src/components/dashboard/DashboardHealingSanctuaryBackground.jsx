...
/** Feathered masks so motion dissolves into the center — no hard vertical “cardboard” edge */
const BREEZE_LAYERS = [
  {
...
/**
 * Dashboard backdrop: sharp static photograph with soft, blurred breeze layers on the
 * left (feathered masks) so motion feels like air — not a rigid sliding cut-out.
 */
